...
function update_subject($subject)
{
  ...
  $errors = validate_subject($subject);
// if its not empty (meaning there are errors) then return the errors
  if(!empty($errors)){
    return $errors;
  }
...
// This function create a query to delete a pages by it's id
...
//validate user name as well as make sure that username does not already exist
  ...
  // gives error message if password is blank or does not match
